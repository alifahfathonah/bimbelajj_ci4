            ...
            <div class="card-box">
                ...
                <div class="panel-body">
                    <div class="text-left">
                        ...
                        <p class="text-muted font-13"><strong>Tgl Lahir :</strong> <span class="m-l-15"><?= $dt->tgl_lahir; ?></span></p>
                        <p class="text-muted font-13"><strong>Alamat :</strong> <span class="m-l-15"><?= $dt->alamat; ?></span></p>
                        <p class="text-muted font-13"><strong>Nomor HP :</strong> <span class="m-l-15"><?= $dt->nomor_hp; ?></span></p>
                        <p class="text-muted font-13"><strong>Asal Sekolah :</strong> <span class="m-l-15"><?= $dt->asal_sekolah; ?></span></p>
                        <p class="text-muted font-13"><strong>Alamat Sekolah :</strong> <span class="m-l-15"><?= $dt->alamat_sekolah ?></span></p>
                        <p class="text-muted font-13"><strong>Kelas :</strong> <span class="m-l-15"><?= $dt->nama_kelas; ?></span></p>
                        <p class="text-muted font-13"><strong>Program Pilihan :</strong> <span class="m-l-15"><?= $dt->nama_program; ?></span></p>
                        <p class="text-muted font-13"><strong>Status :</strong> <span class="m-l-15"><?= $dt->status_diterima; ?></span></p>
                    </div>
